...
<ComponentPreviewTabs>
    <ContextMenu>
        <ContextMenuTrigger>
            <div
                class="flex h-32 w-64 items-center justify-center rounded-lg border border-dashed text-sm text-muted-foreground select-none"
            >
                Right-click here
            </div>
        </ContextMenuTrigger>
        <ContextMenuPopup>
            ...
            <ContextMenuCheckboxItem>Show Extensions</ContextMenuCheckboxItem>
            <ContextMenuCheckboxItem disabled>Show Preview</ContextMenuCheckboxItem>
            <ContextMenuSeparator />
            <ContextMenuGroup>
            ...
            <ContextMenuSeparator />
            <ContextMenuCheckboxItem variant="switch">Auto Arrange</ContextMenuCheckboxItem>
            <ContextMenuSeparator />
            <ContextMenuSub>
                ...
                <ContextMenuSubPopup>
                    ...
                    <ContextMenuSub>
                        <ContextMenuSubTrigger>Text Editor</ContextMenuSubTrigger>
                        <ContextMenuSubPopup>
                            <ContextMenuItem>Vim</ContextMenuItem>
                            <ContextMenuItem>Emacs</ContextMenuItem>
                            <ContextMenuItem>Nano</ContextMenuItem>
                            <ContextMenuSeparator />
