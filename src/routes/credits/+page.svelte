<main class="container py-12 md:py-16">
  <article class="mx-auto max-w-2xl space-y-6 text-foreground">
    ...
    <p class="text-base/7 text-muted-foreground">
      ...
      >
      and liked its look and feel. Later, I learned that Origin UI was acquired by
      Coss UI and that an updated component library existed, but only for React.
    </p>
    ...
    <p class="text-base/7 text-muted-foreground">
      ...
      found in Bits UI and Origin UI. So after exploring through tons of 3rd
      party projects and forgotten pull requests, I brought everything together
      under one umbrella.
    </p>

    <p class="text-base/7 text-muted-foreground">
      My aim is to keep every component in one place, with a consistent look and
      feel — so there's no lengthy search for the right library, and no patching
      components from different sources that don't play nicely together.
    </p>

    <p class="pt-2 font-heading text-lg font-medium italic text-foreground">
      "A full set of good looking components, for the most intuitive web
      framework."
    </p>
    ...
    <p class="text-base/7 text-muted-foreground">
      Other good source of inspiration, sometimes with full component logic just
      copy/pasted (full credits to their authors/contributors):
    </p>
