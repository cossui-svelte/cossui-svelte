...
export const metadata: Record<string, ParticleMetaDefinition> = {
  ...
  "p-command-2": {
    ...
    tags: ["command","dialog"],
    npmDependencies: ["lucide-react"],
    registryDependencies: ["autocomplete","button","command","empty","input","kbd","scroll-area","skeleton","spinner"]
  },
  "p-dialog-1": {
  ...
  "p-drawer-12": {
    ...
    tags: ["drawer","dialog"],
    registryDependencies: ["button","dialog","drawer","field","form","input","use-media-query"]
  },
  "p-drawer-13": {
