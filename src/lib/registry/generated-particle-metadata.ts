...
export const metadata: Record<string, ParticleMetaDefinition> = {
  ...
  "p-calendar-22": {
    ...
    npmDependencies: ["@internationalized/date"],
    registryDependencies: ["range-calendar"],
    meta: { class: "**:data-[slot=preview]:w-full sm:**:data-[slot=preview]:max-w-[80%]", colSpan: 2 }
  },
  "p-calendar-23": {
  ...
  "p-card-1": {
    ...
    meta: { class: "**:data-[slot=preview]:w-full **:data-[slot=preview]:flex **:data-[slot=preview]:justify-center" }
  },
  "p-card-2": {
  ...
  "p-card-8": {
    ...
    npmDependencies: ["@lucide/svelte","zod"],
    registryDependencies: ["button","card","field","form","frame","input","select","use-superform"],
    meta: { class: "**:data-[slot=preview]:w-full **:data-[slot=preview]:flex **:data-[slot=preview]:justify-center" }
  },
  "p-card-9": {
    description: "Card within a frame and footer",
  ...
  "p-checkbox-group-5": {
    ...
    npmDependencies: ["zod"],
    registryDependencies: ["button","checkbox","checkbox-group","field","fieldset","form","use-superform"],
    meta: { class: "**:data-[slot=preview]:w-full sm:**:data-[slot=preview]:max-w-[80%]" }
  },
  "p-collapsible-1": {
  ...
  "p-dialog-4": {
    ...
    tags: ["alert-dialog","dialog"],
    npmDependencies: ["zod"],
    registryDependencies: ["alert-dialog","button","dialog","field","form","textarea","use-superform"],
    meta: { class: "**:data-[slot=preview]:w-full sm:**:data-[slot=preview]:max-w-[80%]" }
  },
  "p-dialog-5": {
  ...
  "p-field-18": {
    ...
    npmDependencies: ["zod"],
    registryDependencies: ["button","checkbox","field","form","input","select","use-superform"],
    meta: { class: "**:data-[slot=preview]:w-full **:data-[slot=preview]:max-w-64" }
  },
  "p-fieldset-1": {
  ...
  "p-input-group-24": {
    ...
    registryDependencies: ["input-group","use-character-limit"],
    meta: { class: "**:data-[slot=preview]:w-full **:data-[slot=preview]:max-w-64" }
  },
  "p-input-18": {
    description: "Input with characters remaining counter",
    tags: ["field","input"],
    registryDependencies: ["input","use-character-limit"],
    meta: { class: "**:data-[slot=preview]:w-full **:data-[slot=preview]:max-w-64" }
  },
  "p-input-19": {
  ...
  "p-pagination-3": {
    ...
    registryDependencies: ["pagination","select"],
    meta: { class: "**:data-[slot=preview]:w-full" }
  },
  "p-popover-1": {
  ...
  "p-popover-4": {
    ...
    npmDependencies: ["@lucide/svelte"],
    registryDependencies: ["badge","button","checkbox","checkbox-group","group","label","popover"],
    meta: { class: "**:data-[slot=preview]:w-full sm:**:data-[slot=preview]:max-w-[80%]" }
  },
  "p-preview-card-1": {
  ...
  "p-slider-21": {
    ...
    npmDependencies: ["@lucide/svelte"],
    registryDependencies: ["button","label","number-field","slider"],
    meta: { class: "**:data-[slot=preview]:w-full **:data-[slot=preview]:max-w-64" }
  },
  "p-slider-22": {
  ...
  "p-switch-7": {
    ...
    npmDependencies: ["@lucide/svelte"],
    registryDependencies: ["button","checkbox","checkbox-group","combobox","label","popover","select","switch","tooltip"],
  ...
  "p-switch-8": {
    ...
    npmDependencies: ["@lucide/svelte"],
    registryDependencies: ["button","checkbox","checkbox-group","combobox","group","label","popover","switch","tooltip"],
    meta: { class: "**:data-[slot=preview]:w-full sm:**:data-[slot=preview]:max-w-4xl", colSpan: 2 }
  },
  "p-switch-9": {
  ...
  "p-table-4": {
    ...
    npmDependencies: ["@lucide/svelte"],
    registryDependencies: ["badge","checkbox","frame","pagination","select","table"],
    meta: { class: "**:data-[slot=preview]:w-full sm:**:data-[slot=preview]:max-w-4xl", colSpan: 2 }
  },
  "p-table-5": {
  ...
  "p-table-8": {
    ...
    npmDependencies: ["@lucide/svelte"],
    registryDependencies: ["badge","card","checkbox","pagination","select","table"],
    meta: { class: "**:data-[slot=preview]:w-full sm:**:data-[slot=preview]:max-w-4xl", colSpan: 2 }
  },
  "p-tabs-1": {
  ...
  "p-alert-dialog-319": {
    description: "Terms & conditions dialog that unlocks the agree button once you've scrolled to the bottom",
    tags: ["alert-dialog"],
    registryDependencies: ["button","dialog","scroll-area"],
    meta: { class: "**:data-[slot=preview]:w-full sm:**:data-[slot=preview]:max-w-[80%]" }
  },
  ...
  "p-alert-dialog-323": {
    ...
    tags: ["alert-dialog"],
    registryDependencies: ["button","dialog","label","radio-group","textarea"],
    meta: { class: "**:data-[slot=preview]:w-full sm:**:data-[slot=preview]:max-w-[80%]" }
  },
  "p-alert-dialog-324": {
    description: "OTP verification dialog with automatic code checking",
    tags: ["alert-dialog"],
    registryDependencies: ["button","dialog","otp-field"],
    meta: { class: "**:data-[slot=preview]:w-full sm:**:data-[slot=preview]:max-w-[80%]" }
  },
  "p-alert-dialog-325": {
  ...
  "p-alert-dialog-327": {
    ...
    tags: ["alert-dialog"],
    npmDependencies: ["@lucide/svelte"],
    registryDependencies: ["button","dialog","input","label","tooltip"],
    meta: { class: "**:data-[slot=preview]:w-full sm:**:data-[slot=preview]:max-w-[80%]" }
  },
  "p-alert-dialog-328": {
  ...
  "p-alert-dialog-329": {
    ...
    tags: ["alert-dialog"],
    npmDependencies: ["@lucide/svelte","cleave-zen"],
    registryDependencies: ["badge","button","dialog","input","label","radio-group"],
    meta: { class: "**:data-[slot=preview]:w-full sm:**:data-[slot=preview]:max-w-[80%]" }
  },
  "p-alert-dialog-330": {
    ...
    tags: ["alert-dialog"],
    npmDependencies: ["@lucide/svelte"],
    registryDependencies: ["button","dialog","label","radio-group"],
    meta: { class: "**:data-[slot=preview]:w-full sm:**:data-[slot=preview]:max-w-[80%]" }
  },
  "p-alert-dialog-331": {
    ...
    tags: ["alert-dialog"],
    npmDependencies: ["@lucide/svelte"],
    registryDependencies: ["button","dialog","input","label","textarea","use-character-limit","use-file-upload"],
    meta: { class: "**:data-[slot=preview]:w-full sm:**:data-[slot=preview]:max-w-[80%]" }
  },
  "p-alert-dialog-332": {
