...
{#snippet themePreviews(v)}
  {#if v === 'dark'}
    ...
    >
      ...
      <path class="fill-neutral-800 shadow-sm" d="M10 12a4 4 0 0 1 4-4h74v62H10V12Z"></path>
      <circle class="fill-neutral-600" cx="28" cy="26" r="8"></circle>
      <rect class="fill-neutral-700" height="4" rx="2" width="58" x="20" y="42"></rect>
      <rect class="fill-neutral-700" height="4" rx="2" width="58" x="20" y="49"></rect>
      <rect class="fill-neutral-700" height="4" rx="2" width="29" x="20" y="56"></rect>
    </svg>
  {:else if v === 'light'}
    <svg
      aria-hidden
    ...
    >
      ...
      <path class="fill-white shadow-sm" d="M10 12a4 4 0 0 1 4-4h74v62H10V12Z"></path>
      <circle class="fill-neutral-300" cx="28" cy="26" r="8"></circle>
      <rect class="fill-neutral-200" height="4" rx="2" width="58" x="20" y="42"></rect>
      <rect class="fill-neutral-200" height="4" rx="2" width="58" x="20" y="49"></rect>
      <rect class="fill-neutral-200" height="4" rx="2" width="29" x="20" y="56"></rect>
    </svg>
  {:else}
    <svg
      aria-hidden
    ...
    >
      ...
      <path class="fill-white shadow-sm" d="M10 12a4 4 0 0 1 4-4h30v62H10V12Z"></path>
      <circle class="fill-neutral-300" cx="28" cy="26" r="8"></circle>
      <path
      ...
      ></path>
      <path class="fill-neutral-800 shadow-sm" d="M54 12a4 4 0 0 1 4-4h30v62H54V12Z"></path>
