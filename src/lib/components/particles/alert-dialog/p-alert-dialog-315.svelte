...
<Dialog>
  ...
  <DialogPopup class="gap-0 p-0" showCloseButton={false}>
    <div class="max-h-[min(640px,80vh)] overflow-y-auto">
        ...
        <div class="flex flex-col gap-4 [&_strong]:font-semibold [&_strong]:text-foreground">
          ...
          <div class="flex flex-col gap-1">
            ...
            <p>
              ...
              (free with limited features), Professional (monthly fee with comprehensive access),
              and Enterprise (custom pricing with full platform capabilities).
            </p>
          </div>
          <div class="flex flex-col gap-1">
            ...
            <p>
              ...
              support, live chat during business hours, an integrated support ticket system, and
              phone support specifically for enterprise-level customers.
            </p>
          </div>
          <div class="flex flex-col gap-1">
          ...
          <div class="flex flex-col gap-1">
            ...
            <p>
              ...
              are provided, with special discounts offered for annual commitments.
            </p>
          </div>
          <div class="flex flex-col gap-1">
      ...
      <div
        class="flex flex-col-reverse gap-2 px-6 pb-6 sm:flex-row sm:justify-start max-sm:[&_a]:w-full"
      >
