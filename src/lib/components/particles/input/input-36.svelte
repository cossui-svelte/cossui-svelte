...
<div class="space-y-2">
	...
	<DateField.Root locale={localeCtx.locale}>
		<DateField.Input
			class="relative inline-flex h-9 w-full items-center overflow-hidden whitespace-nowrap rounded-lg border border-input bg-background px-3 py-2 text-sm shadow-sm shadow-black/4 ring-offset-background transition-shadow focus-within:border-ring focus-within:outline-none focus-within:ring-2 focus-within:ring-ring/30 focus-within:ring-offset-2 data-disabled:opacity-50"
		>
