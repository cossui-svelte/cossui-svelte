...
<Drawer>
    ...
    <DrawerPopup showBar>
        <DrawerHeader class="text-center">
            ...
            <DrawerDescription>
                This is the first step. Tap the button below to continue to
                the next screen.
            </DrawerDescription>
        </DrawerHeader>
        <DrawerFooter class="justify-center sm:justify-center" variant="bare">
            <DrawerClose class={buttonVariants({ variant: "ghost" })}>
                Cancel
            </DrawerClose>
            <Drawer>
                <DrawerTrigger class={buttonVariants({ variant: "outline" })}>
                ...
                <DrawerPopup showBar>
                    <DrawerHeader class="text-center">
                        ...
                        <DrawerDescription>
                            You&apos;ve reached the second step. Tap the
                            button below to continue to the next screen.
                        </DrawerDescription>
                    </DrawerHeader>
                    <DrawerPanel>
                            ...
                            <DrawerPopup showBar>
                                <DrawerHeader class="text-center">
                                    ...
                                    <DrawerDescription>
                                        ...
                                        You can close this drawer or go
                                        back.
                                    </DrawerDescription>
                                </DrawerHeader>
                                <DrawerPanel>
