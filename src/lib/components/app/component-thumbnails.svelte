...
{:else if slug === 'chart'}
  <div class={cardCls('max-w-36 [--radius-2xl:14px]')}>
    <div class={cpCls('flex items-end gap-2 p-4')}>
      ...
      <div class="h-16 w-full rounded-sm bg-linear-to-b from-(--btn-from) to-(--btn-to)"></div>
...
{:else if slug === 'kbd'}
  <div class="flex items-center justify-center gap-2">
    <div class={cardCls('size-10 [--radius-2xl:10px]')}>
      <div
        class={cpCls('flex items-center justify-center p-0 text-muted-foreground/88 leading-none')}
      >
        ⌘
      </div>
    </div>
...
{:else if slug === 'meter'}
  <div class="flex max-w-50 flex-1 flex-col gap-2">
    ...
    <div class="h-2 w-full rounded-full bg-muted-foreground/20">
      <div class="h-2 w-[65%] rounded-s-full bg-linear-to-b from-(--btn-from) to-(--btn-to)"></div>
    </div>
  </div>
...
{:else if slug === 'progress'}
  <div class="flex max-w-50 flex-1 flex-col gap-2">
    <div class="h-2 w-full rounded-full bg-muted-foreground/20">
      <div class="h-2 w-[45%] rounded-s-full bg-linear-to-b from-(--btn-from) to-(--btn-to)"></div>
    </div>
  </div>
  ...
  <div class={cardCls('max-w-50 [--radius-2xl:14px]')}>
    <div class={cpCls('flex flex-col gap-0 p-0')}>
      <div class="flex items-center gap-1 border-b border-border p-2">
        <div class="flex size-6 items-center justify-center rounded-sm bg-muted-foreground/8">
...
{:else if slug === 'slider'}
  <div class="flex w-full max-w-50 items-center gap-1">
    <div class="h-1.5 w-[35%] rounded-full bg-linear-to-b from-(--btn-from) to-(--btn-to)"></div>
...
{:else if slug === 'split-pane'}
  <div class="flex max-w-50 flex-1 gap-1.5">
    ...
    <div class="flex items-center">
      <div class="flex h-8 w-3 items-center justify-center rounded-full border bg-card shadow-sm">
...
{:else if slug === 'stepper'}
  <div class="flex max-w-50 flex-1 items-center">
    <div class="flex size-8 shrink-0 items-center justify-center rounded-full bg-foreground">
