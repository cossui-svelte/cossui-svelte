...
{#snippet npmIcon(className?: string)}
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class={cn('size-4', className)}>
    <path
...
{#snippet yarnIcon(className?: string)}
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class={cn('size-4', className)}>
    <path
...
{#snippet pnpmIcon(className?: string)}
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class={cn('size-4', className)}>
    <path
...
{#snippet bunIcon(className?: string)}
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class={cn('size-4', className)}>
    <path
...
<div class="relative">
  ...
  >
    <div class="flex items-center gap-2 border-border/64 border-b bg-muted px-4 py-1 font-mono">
      ...
      >
        {#each Object.entries(tabs) as [key] (key)}
          <TabsTab class="flex items-center gap-1.5 rounded-lg" value={key}>
            {@render { bun: bunIcon, npm: npmIcon, pnpm: pnpmIcon, yarn: yarnIcon }[
              key as 'bun' | 'npm' | 'pnpm' | 'yarn'
            ]()}
            {key}
          </TabsTab>
        {/each}
