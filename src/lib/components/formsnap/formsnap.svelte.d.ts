import type { Getter, ReadableBoxedValues, WithRefProps } from 'svelte-toolbelt';
...
export declare function useField<T extends Record<string, unknown>, U extends FormPath<T>>(
  props: FormFieldStateProps<T, U>
): FormFieldState<T, U>;
export declare function useElementField<T extends Record<string, unknown>, U extends FormPath<T>>(
...
>(): FieldState<T, U>;
export declare function useFieldErrors<
  T extends Record<string, unknown> = Record<string, unknown>,
  U extends FormPath<T> = FormPath<T>
>(props: FieldErrorsStateProps): FieldErrorsState<T, U>;
