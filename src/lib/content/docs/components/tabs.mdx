...
For guidance on choosing between Tabs, Radio Group, Toggle Group, and navigation links, see the [Segmented Control](/docs/components/segmented-control) pattern.
