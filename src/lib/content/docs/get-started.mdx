...
See the [Styling](/docs/styling) guide for more details.
...
- **[Agent Skills](/docs/skills)** — Install coss knowledge directly into your AI assistant with `npx skills add cosscom/coss`. Covers all 53 primitives, styling conventions, migration patterns, and particle examples.
