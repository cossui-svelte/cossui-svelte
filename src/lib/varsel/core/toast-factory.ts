...
import type { PromiseToastState, ToastData, ToastInvoker, ToastPromiseOptions } from './types';

/**
 * Helper to normalize string input into a ToastData object.
 */
const normalizeToastData = (data: Omit<ToastData, 'id'> | string): Omit<ToastData, 'id'> => {
 ...
 */
createToast.success = (data: Omit<ToastData, 'id' | 'variant'> | string): string => {
  if (typeof data === 'string') {
 ...
 */
createToast.warning = (data: Omit<ToastData, 'id' | 'variant'> | string): string => {
  if (typeof data === 'string') {
 ...
 */
createToast.info = (data: Omit<ToastData, 'id' | 'variant'> | string): string => {
  if (typeof data === 'string') {
 ...
 */
createToast.error = (data: Omit<ToastData, 'id' | 'variant'> | string): string => {
  if (typeof data === 'string') {
